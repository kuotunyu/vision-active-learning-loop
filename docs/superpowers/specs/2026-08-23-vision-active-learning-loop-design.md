...
**Status:** A8 cache-and-lease lifecycle compatibility design amendment active
**Milestone:** M0 complete for the original design; A6 remains frozen at `WAVE0_A6_NORMATIVE_FAIL / WAVE1_FORBIDDEN`; the latest A7 campaign is closed and inconclusive before model-contract execution
