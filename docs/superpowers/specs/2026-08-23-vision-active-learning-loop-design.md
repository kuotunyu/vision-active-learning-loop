...
**Status:** A6 deterministic-attention design amendment owner-authorized / written specification review pending
**Milestone:** M0 complete for the original design; the A5 diagnostic campaign is frozen at `WAVE0_A5_DIAGNOSTIC_CAPTURED / WAVE0_NOT_PASSED / WAVE1_FORBIDDEN`; A6 design amendment active
