...
Run: `uv run val protocol freeze --spec docs/archive/wave0/2026-08-23-vision-active-learning-loop-design.md --pilot <pilot-audit.json> --projections <projection-root> --output "$VAL_ARTIFACT_ROOT/pilot/protocol-freeze-receipt.json" && uv run pytest tests/protocol/test_freeze.py tests/gates/test_wave4_gate.py -v`
